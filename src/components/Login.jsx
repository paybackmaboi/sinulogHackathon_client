...
const Login = () => {
  ...
  // Styling Constants (Matches SignUp.jsx)
  const primaryText = "text-[#137fec]";
  const primaryBg = "bg-[#137fec]";
  const primaryBorder = "border-[#137fec]";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // response includes: { success: true, role: 'admin', username: '...', id: ... }
      localStorage.setItem('user', JSON.stringify(response));

      // 3. Redirect based on Role (Matches SignUp Logic)
      if (response.role === 'admin') {
        navigate('/owner-dashboard'); // Property Owner / Admin
      } else {
        navigate('/user-dashboard'); // Tourist / Renter
      }
    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden font-sans bg-[#f6f7f8] dark:bg-[#101922] text-[#111418] dark:text-white antialiased transition-colors duration-300">
      ...
      <div className="relative z-10 w-full max-w-[480px] p-4">
        <div className="bg-white dark:bg-[#1a2632] rounded-2xl shadow-2xl overflow-hidden border border-gray-200/60 dark:border-gray-700/60 backdrop-blur-sm">
          ...
          <div className="px-8 pt-8 pb-4 text-center">
            ...
            <p className="text-[#617589] dark:text-gray-400 text-base font-normal">
              Manage your properties or book your next stay.
            </p>
          </div>
          ...
          <div className="px-8 pb-8 pt-2">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-medium text-[#111418] dark:text-gray-200">Username</label>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <div className="relative flex items-center">
                    <input 
                      type="checkbox" 
                      className={`peer h-4 w-4 cursor-pointer appearance-none rounded border border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-800 checked:${primaryBg} checked:border-transparent transition-all`}
                    />
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-400/80 dark:text-gray-500/80 font-normal">
            © 2025 CebuEstate AI. All rights reserved.
          </p>
        </div>
      </div>
    </div>
